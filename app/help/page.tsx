  ...
  const faqs: FAQItem[] = [
    {
      ...
      answer:
        "TELATEN adalah aplikasi keuangan UMKM yang inklusif dan mudah digunakan. Anda bisa mencatat transaksi dengan cara bercerita seperti chat biasa, dan TELATEN akan mencatatnya dengan sabar.",
    },
    {
      category: "Umum",
      question: "Apakah TELATEN gratis?",
      answer:
        "Ya! TELATEN menyediakan fitur dasar secara gratis selamanya. Anda bisa mencatat transaksi, melihat laporan keuangan sederhana, dan menggunakan asisten AI tanpa biaya.",
    },
    {
      category: "Transaksi",
      question: "Bagaimana cara mencatat transaksi?",
      answer:
        'Ada 2 cara mudah: 1) Gunakan Asisten AI - ceritakan transaksi Anda seperti chat biasa, misalnya "Hari ini jual 10 nasi goreng @15rb". 2) Input manual di halaman Keuangan dengan mengisi form.',
    },
    {
      category: "Transaksi",
      question: "Apakah data transaksi saya aman?",
      answer:
        "Sangat aman! Data Anda dienkripsi dan disimpan dengan standar keamanan tinggi. Kami tidak akan membagikan data Anda ke pihak ketiga tanpa izin Anda.",
    },
    {
      category: "Misi",
      question: "Apa itu Misi dan XP?",
      answer:
        "Misi adalah tugas harian yang membantu Anda belajar mengelola keuangan dengan lebih baik. Setiap misi yang diselesaikan memberikan XP (Experience Points) yang akan menaikkan level Anda.",
    },
    {
      category: "Misi",
      question: "Apa manfaat naik level?",
      answer:
        "Semakin tinggi level Anda, semakin banyak fitur premium dan badge eksklusif yang bisa Anda dapatkan. Anda juga akan mendapat insight bisnis yang lebih advanced.",
    },
    {
      category: "Laporan",
      question: "Bagaimana cara melihat laporan keuangan?",
      answer:
        "Kunjungi halaman Dashboard untuk melihat ringkasan keuangan Anda, atau halaman Keuangan untuk detail transaksi. Anda bisa filter berdasarkan tanggal dan kategori.",
    },
    {
      category: "Laporan",
      question: "Apakah bisa export laporan ke Excel?",
      answer:
        "Fitur export laporan akan segera tersedia di versi Pro. Saat ini Anda bisa screenshot atau salin data secara manual.",
    },
    {
      category: "Akun",
      question: "Bagaimana cara mengubah profil saya?",
      answer:
        "Klik menu Profil di sidebar, lalu klik tombol Edit Profil. Anda bisa mengubah nama, email, nomor telepon, dan informasi bisnis Anda.",
    },
    {
      category: "Akun",
      question: "Lupa password, bagaimana?",
      answer:
        'Klik "Lupa Password?" di halaman login, masukkan email Anda, dan kami akan mengirimkan link reset password ke email Anda.',
    },
    {
      category: "Teknis",
      question: "Aplikasi berjalan lambat, apa yang harus dilakukan?",
      answer:
        "Coba clear cache browser Anda, tutup tab lain yang tidak terpakai, atau gunakan browser yang lebih modern seperti Chrome atau Firefox versi terbaru.",
    },
    {
      category: "Teknis",
      question: "Apakah TELATEN bisa diakses offline?",
      answer:
        "Saat ini TELATEN memerlukan koneksi internet. Namun, kami sedang mengembangkan fitur offline yang akan segera hadir.",
    },
  ];
        ...
        <Card className="mb-6 bg-gradient-to-br from-pink-50 to-purple-50 dark:from-pink-900/20 dark:to-purple-900/20 border-pink-200 dark:border-pink-800">
          <CardContent className="p-6 md:p-8 text-center">
            ...
            <p className="text-gray-600 dark:text-gray-300 mb-6">
              Cari jawaban dari pertanyaan yang sering ditanyakan atau hubungi
              tim support kami
            </p>
            ...
            >
              ...
              <div>
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400">
                  Respon instan untuk pertanyaan Anda
                </p>
              </div>
            </Button>
