  ...
  return (
    <>
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
        <MobileHeading title="Leaderboard"></MobileHeading>
        <div className="max-w-4xl mx-auto px-4 py-6 md:py-8 space-y-5">
          <header className="mb-6 items-center justify-between md:flex hidden">
                          ...
                          <div className="flex items-center gap-2 truncate">
                            ...
                            <div className="flex md:items-center md:flex-row md:gap-2 flex-col">
                              <div className="flex-1 min-w-0 truncate">
                                ...
                                {isCurrentUser && (
                                  <span className="ml-2 px-2 rounded-full text-xs font-bold bg-primary text-white md:inline hidden">
                                    Kamu
                                  </span>
                                )}
                              </div>
